...
<body>
  ...
  <div class="container">
    <?php
      define("CATEGORIAS", array("Profesor", "Estudiante", "Padre"));
      define("MODULOS_PROFESOR", array("Asignaturas", "registro de notas", "reuniones", "tutorías"));
      define("MODULOS_ESTUDIANTE", array("Asignaturas cursadas", "registro de notas"));
      define("MODULOS_PADRE", array("Reuniones", "registro de notas"));
      ...
      <div class="col s7">
        ...
        <form class="" action="index.html" method="post">
          <div class="input-field col s12">
             <select>
                <option value=""></option>
<?php           foreach(MODULOS_PROFESOR as $index => $modulo){                   ?>
...
<?php
    }elseif($tipoUsuario == CATEGORIAS[1]){
?>
    <div class="row mod-container">
      <div class="col s7">
        ...
        <form class="" action="index.html" method="post">
          <div class="input-field col s12">
             <select>
                 <option value=""></option>
<?php           foreach(MODULOS_ESTUDIANTE as $index => $modulo){                   ?>
                  <option value=<?php echo $modulo;?>><?php echo $modulo;?></option>
<?php           }
?>                 
             </select>
...
<?php
    }elseif($tipoUsuario == CATEGORIAS[2]){
?>
    <div class="row mod-container">
      <div class="col s5">
        <div class="card">
      ...
      <div class="col s7">
        ...
        <form class="" action="index.html" method="post">
          <div class="input-field col s12">
             <select>
                 <option value=""></option>
<?php           foreach(MODULOS_PADRE as $index => $modulo){                   ?>
                  <option value=<?php echo $modulo;?>><?php echo $modulo;?></option>
<?php           }
?>
             </select>
