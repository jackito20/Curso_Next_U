            ...
            <tbody>
              <?php foreach ($usuario_acceso->getAsignaturas() as $key => $value) { ?>
                <tr>
                  ...
                  <td class="nota-definitiva"><?php echo number_format($value->promedio(),1,'.','')?></td>
                </tr>
              <?php } ?>
            </tbody>
          </table>
                ...
                <tr>
                  ...
                  <td>
                    <table class="bordered">
                      <?php foreach ($estudiante->getAsignaturas() as $key => $asignatura) { ?>
                      <tr>
                        <td class="nota-definitiva"><?php echo number_format($asignatura->promedio(),1,'.','')?></td>
                      </tr>
                      <?php } ?>
                    </table>
                  </td>
